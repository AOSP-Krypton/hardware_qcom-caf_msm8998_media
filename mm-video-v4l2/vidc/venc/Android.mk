...
libmm-venc-inc      += $(TOP)/$(call get-caf-path,media)/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(call get-caf-path,media)/mm-core/inc
libmm-venc-inc      += $(call get-caf-path,media)/libstagefrighthw
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += $(call get-caf-path,media)/libc2dcolorconvert
libmm-venc-inc      += $(call get-caf-path,media)/hypv-intercept
