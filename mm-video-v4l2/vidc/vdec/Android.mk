...
libmm-vdec-inc          += $(TOP)/$(call get-caf-path,media)/mm-video-v4l2/vidc/common/inc
libmm-vdec-inc          += $(TOP)/$(call get-caf-path,media)/mm-core/inc
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/qcom/display
libmm-vdec-inc          += $(TARGET_OUT_HEADERS)/adreno
libmm-vdec-inc          += $(TOP)/$(call get-caf-path,media)/libc2dcolorconvert
libmm-vdec-inc          += $(TOP)/$(call get-caf-path,media)/hypv-intercept
...
libmm-vdec-inc += $(TOP)/$(call get-caf-path,media)/libstagefrighthw
endif
